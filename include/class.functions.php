...
class CptoFunctions {
	...
	/**
	 * Returns user level.
	 * This is deprecated, will be removed in the next version.
	 *
	 * @param bool $return_as_numeric
	 *
	 * @return int|string
	 */
	...
	public function get_options() {
		...
		// PHPCS error: Words in hook names should be separated using underscore. Expecting pto_get_options.
	...
	*/
	public function cpt_info_box() {
		...
		<div id="cpt_info_box">
			<div id="p_right">
				...
				<div id="p_socialize">
					...
					<div class="p_s_item s_t">
						<?php // @codingStandardsIgnoreStarts - PHPCS issue: Script must be enqueued. ?>
			...
			<?php // Text / String outputs to be escaped. ?>
			...
			<h4><?php esc_html_e( 'Did you know there is available an Advanced version of this plug-in?', 'post-types-order' ); ?> <a target="_blank" href="http://www.nsp-code.com/premium-plugins/wordpress-plugins/advanced-post-types-order/"><?php _esc_html( 'Read more', 'post-types-order' ); ?></a></h4>
	...
	public function cpto_get_previous_post_where( $where, $in_same_term, $excluded_terms ) {
		...
		// @codingStandardsIgnoreStarts - PHPCS issue: placeholders in query
		$query   = $wpdb->prepare(
	...
	public function cpto_get_next_post_where( $where, $in_same_term, $excluded_terms ) {
		...
		// @codingStandardsIgnoreStarts - issue: placeholder in query
